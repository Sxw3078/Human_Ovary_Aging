...
for(i in 1:nrow(sample_list)){
    ...
    ggsave(plot2, width=5, height=5,dpi=600,units ="in",bg="white", filename= paste("06_mapping_ref_all_cells",paste0("spatial_scatterpie_",sample_list[i,1],".png"),sep="/"),limitsize = FALSE)
