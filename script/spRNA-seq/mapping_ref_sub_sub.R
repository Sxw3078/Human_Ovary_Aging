...
option_list <- list(
       ...
       # make_option(c("-l", "--resolution"),type="double", help="resolution value for FindClusters, default %default",default="1.0"),
        ...
        make_option(c("-d", "--spatial_data"), help="rds for spatial data with celltypes, default %default",default="suerat_Rdata/Y28_spatial_cell_locations.mapping.ref.rds"),
        make_option(c("-z", "--singcell"), help="rds for singcell data, default %default",default="suerat_Rdata/sc_combined_TS2_subclusters.rds"),  
        make_option(c("-t", "--celltype"), help="which celltype or celltypes to be subclustered, default %default",default="Theca & stroma_2"),     
...
if(3==3){
  ...
  spatial.ct@meta.data[,"Theca & stroma_2"] = spatial.ct2$"Theca & stroma_2"
  spatial.ct@meta.data[,"Theca & stroma_3"] = spatial.ct2$"Theca & stroma_3"
  ...
  spatial.ct@meta.data[,"Theca & stroma_6"] = NULL
  spatial.ct@meta.data[,"Theca & stroma_7"] = NULL
  spatial.ct@meta.data[,"Theca & stroma_8"] = NULL
