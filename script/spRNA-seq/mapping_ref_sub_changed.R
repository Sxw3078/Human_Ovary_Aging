...
option_list <- list(
       ...
       # make_option(c("-l", "--resolution"),type="double", help="resolution value for FindClusters, default %default",default="1.0"),
        ...
        make_option(c("-d", "--spatial_data"), help="rds for spatial data with celltypes, default %default",default="suerat_Rdata/Y1_1_spatial_cell_locations.mapping.ref.rds"),
        ...
        make_option(c("-t", "--celltype"), help="which celltype or celltypes to be subclustered, default %default",default="Theca & stroma"),     
...
color.ls <- list(
    ...
    'Lancet' = c(
		"#00468B", "#EC0000", "#41B43F", "#0099B3", "#B8860B", "#FDAE91", "#AC002A",
...
if(2==3){
  ...
  spatial.ct$Theca & stroma_1 = spatial.ct2$Theca & stroma_1 + spatial.ct2$Theca & stroma_5
  spatial.ct$Theca & stroma_2 = spatial.ct2$Theca & stroma_2 + spatial.ct2$Theca & stroma_3
  spatial.ct$Theca & stroma_3 = spatial.ct2$Theca & stroma_4 
  spatial.ct$Theca & stroma_4=NULL
  spatial.ct$Theca & stroma_5=NULL
  cell_types_interest=cell_types_interest[c(1:3)]
...
if(3==3){
  ...
  num1=0
  if(( "Theca & stroma_0" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_1" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_4" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_5" %in% colnames(spatial.ct2@meta.data))){
    spatial.ct@meta.data[,"Theca & stroma_1"] = spatial.ct2$"Theca & stroma_0"
    num1=1
  }
  if((! "Theca & stroma_0" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_1" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_4" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_5" %in% colnames(spatial.ct2@meta.data))){
    spatial.ct@meta.data[,"Theca & stroma_1"] = spatial.ct2$"Theca & stroma_1" 
    num1=1
  }
  if((! "Theca & stroma_0" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_1" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_4" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_5" %in% colnames(spatial.ct2@meta.data))){
    spatial.ct@meta.data[,"Theca & stroma_1"] = spatial.ct2$"Theca & stroma_4"
    num1=1
  }
  if((! "Theca & stroma_0" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_1" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_4" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_5" %in% colnames(spatial.ct2@meta.data))){
    spatial.ct@meta.data[,"Theca & stroma_1"] = spatial.ct2$"Theca & stroma_5"
    num1=1
  }
  if(( "Theca & stroma_0" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_1" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_4" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_5" %in% colnames(spatial.ct2@meta.data))){
    spatial.ct@meta.data[,"Theca & stroma_1"] = spatial.ct2$"Theca & stroma_0" + spatial.ct2$"Theca & stroma_1"
    num1=1
  }
  if(("Theca & stroma_0" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_1" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_4" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_5" %in% colnames(spatial.ct2@meta.data))){
    spatial.ct@meta.data[,"Theca & stroma_1"] = spatial.ct2$"Theca & stroma_0" + spatial.ct2$"Theca & stroma_4"
    num1=1
  }
  if(("Theca & stroma_0" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_1" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_4" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_5" %in% colnames(spatial.ct2@meta.data))){
    spatial.ct@meta.data[,"Theca & stroma_1"] = spatial.ct2$"Theca & stroma_0" + spatial.ct2$"Theca & stroma_5"
    num1=1
  }
  if((! "Theca & stroma_0" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_1" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_4" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_5" %in% colnames(spatial.ct2@meta.data))){
    spatial.ct@meta.data[,"Theca & stroma_1"] = spatial.ct2$"Theca & stroma_1" + spatial.ct2$"Theca & stroma_4"
    num1=1
  }
  if((! "Theca & stroma_0" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_1" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_4" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_5" %in% colnames(spatial.ct2@meta.data))){
    spatial.ct@meta.data[,"Theca & stroma_1"] = spatial.ct2$"Theca & stroma_1" + spatial.ct2$"Theca & stroma_5"
    num1=1
  }
  if((! "Theca & stroma_0" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_1" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_4" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_5" %in% colnames(spatial.ct2@meta.data))){
    spatial.ct@meta.data[,"Theca & stroma_1"] = spatial.ct2$"Theca & stroma_4" + spatial.ct2$"Theca & stroma_5"
    num1=1
  }
  if((! "Theca & stroma_0" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_1" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_4" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_5" %in% colnames(spatial.ct2@meta.data))){
    spatial.ct@meta.data[,"Theca & stroma_1"] = spatial.ct2$"Theca & stroma_1" + spatial.ct2$"Theca & stroma_4" + spatial.ct2$"Theca & stroma_5"
    num1=1
  }
  if(( "Theca & stroma_0" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_1" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_4" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_5" %in% colnames(spatial.ct2@meta.data))){
    spatial.ct@meta.data[,"Theca & stroma_1"] = spatial.ct2$"Theca & stroma_0" + spatial.ct2$"Theca & stroma_4" + spatial.ct2$"Theca & stroma_5"
    num1=1
  }
  if(( "Theca & stroma_0" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_1" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_4" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_5" %in% colnames(spatial.ct2@meta.data))){
    spatial.ct@meta.data[,"Theca & stroma_1"] = spatial.ct2$"Theca & stroma_0" + spatial.ct2$"Theca & stroma_1" + spatial.ct2$"Theca & stroma_5"
    num1=1
  }
  if(( "Theca & stroma_0" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_1" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_4" %in% colnames(spatial.ct2@meta.data)) & (! "Theca & stroma_5" %in% colnames(spatial.ct2@meta.data))){
    spatial.ct@meta.data[,"Theca & stroma_1"] = spatial.ct2$"Theca & stroma_0" + spatial.ct2$"Theca & stroma_1" + spatial.ct2$"Theca & stroma_4"
    num1=1
  }
  if(( "Theca & stroma_0" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_1" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_4" %in% colnames(spatial.ct2@meta.data)) & ( "Theca & stroma_5" %in% colnames(spatial.ct2@meta.data))){
    spatial.ct@meta.data[,"Theca & stroma_1"] = spatial.ct2$"Theca & stroma_0" + spatial.ct2$"Theca & stroma_1" + spatial.ct2$"Theca & stroma_4" + spatial.ct2$"Theca & stroma_5"
    num1=1
  }

  num2=num1
  if("Theca & stroma_6" %in% colnames(spatial.ct2@meta.data) & "Theca & stroma_8" %in% colnames(spatial.ct2@meta.data)){
    spatial.ct@meta.data[,"Theca & stroma_4"] = spatial.ct2$"Theca & stroma_6" + spatial.ct2$"Theca & stroma_8"
    num2=num1+1
  } 
  if("Theca & stroma_6" %in% colnames(spatial.ct2@meta.data) & ( ! "Theca & stroma_8" %in% colnames(spatial.ct2@meta.data))){
    spatial.ct@meta.data[,"Theca & stroma_4"] = spatial.ct2$"Theca & stroma_6" 
    num2=num1+1
  } 
  if((! "Theca & stroma_6" %in% colnames(spatial.ct2@meta.data)) & "Theca & stroma_8" %in% colnames(spatial.ct2@meta.data)){
    spatial.ct@meta.data[,"Theca & stroma_4"] =  spatial.ct2$"Theca & stroma_8"
    num2=num1+1
  } 

  num3=num2
  if(( "Theca & stroma_7" %in% colnames(spatial.ct2@meta.data)) ){
    spatial.ct@meta.data[,"Theca & stroma_5"] = spatial.ct2$"Theca & stroma_7"
    num3=num2+1
  }
  num4=num3
  if(( "Theca & stroma_2" %in% colnames(spatial.ct2@meta.data)) ){
    num4=num3+1
  }
  num5=num4
  if(( "Theca & stroma_3" %in% colnames(spatial.ct2@meta.data)) ){
    num5=num4+1
  }
  ...
  if("Theca & stroma_6" %in% colnames(spatial.ct2@meta.data)) {
    spatial.ct$"Theca & stroma_6"=NULL
  }
  if("Theca & stroma_7" %in% colnames(spatial.ct2@meta.data)) {
    spatial.ct$"Theca & stroma_7"=NULL
  }
  if("Theca & stroma_8" %in% colnames(spatial.ct2@meta.data)) {
    spatial.ct$"Theca & stroma_8"=NULL
  }
  if("Theca & stroma_0" %in% colnames(spatial.ct2@meta.data)) {
    spatial.ct$"Theca & stroma_0"=NULL
  }
  num=num5
  cell_types_interest=cell_types_interest[c(2:(num+1),length(cell_types_interest))]
  #cell_types_interest=cell_types_interest[c(2:6,10)]
  # cell_types_interest=cell_types_interest[c(2:6)]
  cols=c(color.ls[[opt$colors]][1:length(cell_types_interest)],"grey")
  names(cols)=c(cell_types_interest,"others")
  cols2=c(color.ls[[opt$colors]][1:length(cell_types_interest)])
  names(cols2)=c(cell_types_interest)
