...
option_list <- list(
       ...
       # make_option(c("-l", "--resolution"),type="double", help="resolution value for FindClusters, default %default",default="1.0"),
        ...
        make_option(c("-d", "--spatial_data"), help="rds for spatial data with celltypes, default %default",default="suerat_Rdata/Y48_spatial_cell_locations.mapping.ref.rds"),
        make_option(c("-z", "--singcell"), help="rds for singcell data, default %default",default="suerat_Rdata/sc_combined.subcluster2.rds"),  
        make_option(c("-t", "--celltype"), help="which celltype or celltypes to be subclustered, default %default",default="Smooth muscle"),     
